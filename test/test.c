...
static DWORD __stdcall pthread_create_wrapper(void *args)
{
...
static int pthread_create(pthread_t *th, void *attr, void *(*func)(void *), void *arg)
{
    ...
    *th = tv;
    ...
    tv->h = (HANDLE)CreateThread(NULL, 0, pthread_create_wrapper, tv, 0, NULL);
